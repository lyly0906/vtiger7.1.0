...
Class Settings_Departments_Edit_View extends Settings_Departments_Index_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$ShowMultiCompany = 0;
		if($recordModel->getParent()->getId() == 'D2'){
			$ShowMultiCompany = 1;
		}
		...
		$viewer->assign('ShowMultiCompany', $ShowMultiCompany);
		$viewer->assign('its4you_company', $recordModel->get('its4you_company'));
		$viewer->assign('parent_company', $recordModel->getParent()->get('its4you_company'));
		$viewer->assign('MODULE', $moduleName);
		$viewer->assign('USER_MODEL', Users_Record_Model::getCurrentUserModel());
		$viewer->assign('MultiCompany', ITS4YouMultiCompany_Record_Model::getAll());
