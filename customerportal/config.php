...
class Portal_Config_Data {
	...
	protected static $data = array(
		...
		'crm.url' => 'http://www.vtiger.com',

		//Portal URL without trialing/
		//Example: http://yourdomain.com/portal
		'portal.url' => 'http://www.vtiger.com/customerportal',

		'crm.version' => '7.1.0', // Framework version for API
		'language' => 'zh_cn', // Default Language for API. Note : Changing the language here will not change the default/login language for Portal user.
		'layout' => 'default',
	);
