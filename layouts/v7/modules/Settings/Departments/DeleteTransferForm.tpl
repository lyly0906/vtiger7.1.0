...
{strip}
    <div class="modal-dialog modelContainer">
        {assign var=HEADER_TITLE value={vtranslate('LBL_DELETE_DEPARTMENT', $QUALIFIED_MODULE)}|cat:" - "|cat:{$RECORD_MODEL->getName()}}
            ...
            <form class="form-horizontal" id="roleDeleteForm" method="post" action="index.php">
                ...
                <div name='massEditContent'>
                    <div class="modal-body">
                            <div class="col-sm-5"><div class="control-label fieldLabel pull-right ">{vtranslate('LBL_TRANSFER_TO_OTHER_DEPARTMENT',$QUALIFIED_MODULE)}
