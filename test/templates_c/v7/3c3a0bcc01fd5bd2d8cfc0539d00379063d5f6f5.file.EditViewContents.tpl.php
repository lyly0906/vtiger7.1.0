<?php /* Smarty version Smarty-3.1.7, created on 2018-06-07 03:59:59
         compiled from "D:\php\vtigercrm7.1.0\includes\runtime/../../layouts/v7\modules\Users\partials\EditViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:73815b17b1008d8d84-71649468%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3c3a0bcc01fd5bd2d8cfc0539d00379063d5f6f5' => 
    array (
      0 => 'D:\\php\\vtigercrm7.1.0\\includes\\runtime/../../layouts/v7\\modules\\Users\\partials\\EditViewContents.tpl',
      1 => 1528343996,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '73815b17b1008d8d84-71649468',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5b17b100bbb20',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5b17b100bbb20')) {function content_5b17b100bbb20($_smarty_tpl) {?>
...
"/><?php continue 1?><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='department'&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')!=''){?><?php $_smarty_tpl->tpl_vars["departmentname"] = new Smarty_variable($_smarty_tpl->tpl_vars['DEPARTMENT_MODEL']->value->getInstanceById($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue'))->get('departmentname'), null, 0);?><script>$(function() {$('input[name=department]').val('<?php echo $_smarty_tpl->tpl_vars['departmentname']->value;?>
');});</script><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isEditable()==true){?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="19"){?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value=='1'){?><td></td><td></td></tr><tr><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['COUNTER']->value==2){?></tr><tr><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(1, null, 0);?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable($_smarty_tpl->tpl_vars['COUNTER']->value+1, null, 0);?><?php }?><td class="fieldLabel alignMiddle"><?php if ($_smarty_tpl->tpl_vars['isReferenceField']->value=="reference"){?><?php if ($_smarty_tpl->tpl_vars['refrenceListCount']->value>1){?><select style="width: 140px;" class="select2 referenceModulesList"><?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
