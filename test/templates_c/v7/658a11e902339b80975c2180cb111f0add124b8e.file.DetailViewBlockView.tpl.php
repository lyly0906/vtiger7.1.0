<?php /* Smarty version Smarty-3.1.7, created on 2018-06-07 03:57:06
         compiled from "D:\php\vtigercrm7.1.0\includes\runtime/../../layouts/v7\modules\Users\DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:104875b17b29aa96281-31696715%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '658a11e902339b80975c2180cb111f0add124b8e' => 
    array (
      0 => 'D:\\php\\vtigercrm7.1.0\\includes\\runtime/../../layouts/v7\\modules\\Users\\DetailViewBlockView.tpl',
      1 => 1528343823,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '104875b17b29aa96281-31696715',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5b17b29b2d1e0',
  'variables' => 
  array (
    'DAY_STARTS' => 0,
    'RECORD_STRUCTURE' => 0,
...
<?php if ($_valid && !is_callable('content_5b17b29b2d1e0')) {function content_5b17b29b2d1e0($_smarty_tpl) {?>
...
?><?php $_smarty_tpl->tpl_vars['fieldDataType'] = new Smarty_variable($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType(), null, 0);?><?php if (!$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isViewableInDetailView()){?><?php continue 1?><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='theme'||$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='rowheight'){?><?php continue 1?><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getName()=='department'){?><?php $_smarty_tpl->tpl_vars["departmentname"] = new Smarty_variable($_smarty_tpl->tpl_vars['DEPARTMENT_MODEL']->value->getInstanceById($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue'))->get('departmentname'), null, 0);?><script>$(function() {$('#Users_detailView_fieldValue_department').find('span').eq(0).text('<?php echo $_smarty_tpl->tpl_vars['departmentname']->value;?>
');$('#Users_detailView_fieldValue_department').find('span').eq(1).find('input').attr('data-displayvalue','<?php echo $_smarty_tpl->tpl_vars['departmentname']->value;?>
');$('#Users_detailView_fieldValue_department').find('span').eq(1).find('input').attr('data-value','<?php echo $_smarty_tpl->tpl_vars['departmentname']->value;?>
');});</script><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="83"){?><?php  $_smarty_tpl->tpl_vars['tax'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax']->_loop = false;
