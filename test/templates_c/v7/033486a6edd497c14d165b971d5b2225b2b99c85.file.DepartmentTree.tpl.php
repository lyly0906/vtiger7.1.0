<?php /* Smarty version Smarty-3.1.7, created on 2018-06-08 06:21:47
         compiled from "D:\php\vtigercrm7.1.0\includes\runtime/../../layouts/v7\modules\Settings\Departments\DepartmentTree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:62675b18af30004b05-97240737%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '033486a6edd497c14d165b971d5b2225b2b99c85' => 
    array (
      0 => 'D:\\php\\vtigercrm7.1.0\\includes\\runtime/../../layouts/v7\\modules\\Settings\\Departments\\DepartmentTree.tpl',
      1 => 1528429223,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '62675b18af30004b05-97240737',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5b18af301ba30',
  'variables' => 
  array (
    'ROLE' => 0,
    'CHILD_ROLE' => 0,
...
<?php if ($_valid && !is_callable('content_5b18af301ba30')) {function content_5b18af301ba30($_smarty_tpl) {?>
...
?><li data-role="<?php echo $_smarty_tpl->tpl_vars['CHILD_ROLE']->value->getParentDepartmentstring();?>
" data-roleid="<?php echo $_smarty_tpl->tpl_vars['CHILD_ROLE']->value->getId();?>
"><div class="toolbar-handle"><?php if ($_REQUEST['type']=='Transfer'){?><?php $_smarty_tpl->tpl_vars["SOURCE_ROLE_SUBPATTERN"] = new Smarty_variable(('::').($_smarty_tpl->tpl_vars['SOURCE_ROLE']->value->getId()), null, 0);?><?php if (strpos($_smarty_tpl->tpl_vars['CHILD_ROLE']->value->getParentDepartmentstring(),$_smarty_tpl->tpl_vars['SOURCE_ROLE_SUBPATTERN']->value)!==false){?><a style="white-space: nowrap" data-url="<?php echo $_smarty_tpl->tpl_vars['CHILD_ROLE']->value->getEditViewUrl();?>
...
"><span class="fa fa-trash"></span></a></div><?php }?></div><?php $_smarty_tpl->tpl_vars["ROLE"] = new Smarty_variable($_smarty_tpl->tpl_vars['CHILD_ROLE']->value, null, 0);?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("DepartmentTree.tpl","Settings:Departments"), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</li><?php } ?></ul><?php }} ?>