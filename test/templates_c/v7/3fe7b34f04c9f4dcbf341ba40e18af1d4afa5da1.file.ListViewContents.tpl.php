<?php /* Smarty version Smarty-3.1.7, created on 2018-06-07 03:24:49
         compiled from "D:\php\vtigercrm7.1.0\includes\runtime/../../layouts/v7\modules\Users\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:312935b17b2933aca00-99228341%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3fe7b34f04c9f4dcbf341ba40e18af1d4afa5da1' => 
    array (
      0 => 'D:\\php\\vtigercrm7.1.0\\includes\\runtime/../../layouts/v7\\modules\\Users\\ListViewContents.tpl',
      1 => 1528341884,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '312935b17b2933aca00-99228341',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5b17b293988a0',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5b17b293988a0')) {function content_5b17b293988a0($_smarty_tpl) {?>
...
" nowrap><span class="fieldValue"><span class="value textOverflowEllipsis"><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='department'){?><?php echo $_smarty_tpl->tpl_vars['DEPARTMENT_MODEL']->value->getInstanceById($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value))->get('departmentname');?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value);?>
<?php }?></span></span></td><?php }?><?php } ?></tr><?php } ?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?><tr class="emptyRecordsDiv"><?php ob_start();?><?php echo count($_smarty_tpl->tpl_vars['LISTVIEW_HEADERS']->value);?>
