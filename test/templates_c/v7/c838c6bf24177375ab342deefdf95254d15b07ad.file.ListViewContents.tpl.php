<?php /* Smarty version Smarty-3.1.7, created on 2018-06-08 03:50:57
         compiled from "D:\php\vtigercrm7.1.0\includes\runtime/../../layouts/v7\modules\Books\ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:311205b190dbbb62d84-63596367%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c838c6bf24177375ab342deefdf95254d15b07ad' => 
    array (
      0 => 'D:\\php\\vtigercrm7.1.0\\includes\\runtime/../../layouts/v7\\modules\\Books\\ListViewContents.tpl',
      1 => 1528429826,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '311205b190dbbb62d84-63596367',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5b190dbc2a878',
  'variables' => 
  array (
    'MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_5b190dbc2a878')) {function content_5b190dbc2a878($_smarty_tpl) {?><?php if (!is_callable('smarty_function_showname')) include 'D:\\php\\vtigercrm7.1.0\\libraries\\Smarty\\libs\\plugins\\function.showname.php';
?>
...
?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='email1'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='first_name'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='roleid'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='phone_work'||$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='department'){?><th><a href="#" class="listViewContentHeaderValues" data-nextsortorderval="<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')){?><?php echo $_smarty_tpl->tpl_vars['NEXT_SORT_ORDER']->value;?>
...
"></th><?php }?><?php } ?></tr><?php }?><tbody class="overflow-y"><?php  $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->_loop = false;
...
"><span class="fieldValue"><span class="value"><?php echo smarty_function_showname(array('last_name'=>$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get('last_name'),'first_name'=>$_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value),$_smarty_tpl);?>
</span></span><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isEditable()=='true'&&$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isAjaxEditable()=='true'){?><span class="hide edit"></span><?php }?></td><?php }else{ ?><td class="listViewEntryValue" data-name="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name');?>
" data-rawvalue="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_RAWVALUE']->value;?>
" data-field-type="<?php echo $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getFieldDataType();?>
"><span class="fieldValue"><span class="value"><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()!='email1'){?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->getName()=='department'){?><?php echo $_smarty_tpl->tpl_vars['DEPARTMENT_MODEL']->value->getInstanceById($_smarty_tpl->tpl_vars['LISTVIEW_ENTRY']->value->get($_smarty_tpl->tpl_vars['LISTVIEW_HEADERNAME']->value))->get('departmentname');?>
<?php }else{ ?><?php echo preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value);?>
<?php }?><?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['LISTVIEW_ENTRY_VALUE']->value;?>
<?php }?></span></span><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isEditable()=='true'&&$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->isAjaxEditable()=='true'){?><span class="hide edit"></span><?php }?></td><?php }?><?php }?><?php } ?></tr><?php } ?><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value=='0'){?><tr class="emptyRecordsDiv"><?php ob_start();?><?php echo count($_smarty_tpl->tpl_vars['LISTVIEW_HEADERS']->value);?>
